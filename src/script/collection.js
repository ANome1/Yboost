...
// Stress test - générer des skins aléatoires
async function runStressTest() {
    ...
    try {
        ...
        if (response.ok) {
            showToast(`✅ ${result.count} skins générés avec succès !`, 'success');
        ...
        btn.disabled = false;
        btn.textContent = '🚀 Stress Test (Générer 100 skins aléatoires)';
    }
}
